...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_coriander__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_coriander___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_coriander__);
...
__WEBPACK_IMPORTED_MODULE_1_coriander___default()($form, {
  ...
  onSubmit(data) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(req, namesObj).then(() => {
      data.form.reset();
    }).catch(err => {
      data.inputs.forEach(input => {
        if (input.name === 'email') {
...
$buttonRequest.addEventListener('click', () => {
  __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(req).then(req => {
